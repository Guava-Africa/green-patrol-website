            ...
            <section style={{ padding: '80px 50px' }}>
                <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 style={{ fontSize: '32px', color: green1, marginBottom: '40px', textAlign: 'center' }}>
                            Get In Touch
                        </h2>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <h3 style={{ fontSize: '24px', color: green1, marginBottom: '25px', borderBottom: `2px solid ${green2}`, paddingBottom: '10px' }}>
                                    📍 Our Locations
                                </h3>

                                <div style={{ marginBottom: '30px' }}>
                                    <h4 style={{ fontSize: '18px', color: green1, marginBottom: '10px' }}>HEAD OFFICE</h4>
                                    <p style={{ color: '#666', lineHeight: '1.8', marginBottom: '5px' }}>
                                        55 Lawley Avenue
                                    </p>
                                    <p style={{ color: '#666', lineHeight: '1.8', marginBottom: '5px' }}>
                                        Belvedere
                                ...
                                {/* <div>
                                    <h4 style={{ fontSize: '18px', color: green1, marginBottom: '10px' }}>BRANCH OFFICE</h4>
                                    <p style={{ color: '#666', lineHeight: '1.8', marginBottom: '5px' }}>
                                        45 Business Park, Jinja Road
                                    </p>
                                    <p style={{ color: '#666', lineHeight: '1.8' }}>
                                        Jinja, Uganda
                                    </p>
                            ...
                            <div style={{
                                ...
                                <div style={{ marginBottom: '25px' }}>
                                    <h4 style={{ fontSize: '18px', color: green1, marginBottom: '10px' }}>OFFICE</h4>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{ color: '#666', fontSize: '16px' }}>
                                    <p style={{ marginBottom: '15px', display: 'flex', justifyContent: 'space-between' }}>
