...
import { FaShieldAlt, FaCrosshairs, FaSearch, FaUserShield, FaVideo, FaDog } from 'react-icons/fa'
import { GiSwordman, GiPoliceBadge } from 'react-icons/gi'
    ...
    const services = [
        {
            ...
            icon: <GiPoliceBadge size={48} color={green1} />,
        ...
        },
        {
            ...
            icon: <GiSwordman size={48} color={green1} />,
        ...
        },
        {
            ...
            icon: <FaDog size={48} color={green1} />,
        ...
        },
        {
            ...
            icon: <FaUserShield size={48} color={green1} />,
        ...
        },
        {
            ...
            icon: <FaSearch size={48} color={green1} />,
            features: ['Private Investigations', 'Surveillance Operations', 'Background Checks', 'Fraud Investigations']
        },
        {
            title: 'Digital Surveillance',
            desc: 'Monitoring support that improves visibility, escalation and response coordination. 24/7 surveillance with instant alert capabilities.',
            icon: <FaVideo size={48} color={green1} />,
            ...
            <section style={styles.ctaSection}>
                ...
                >
                    ...
                    <Link href="/contact" style={{ textDecoration: 'none', display: 'inline-block' }}>
                        <motion.button
                            whileHover={{ scale: 1.05, backgroundColor: green2, color: green1 }}
                            whileTap={{ scale: 0.95 }}
